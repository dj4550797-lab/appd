#Thanks @Flixora for helping in this journey 
...
async def render_page(id, secure_hash, src=None):
    file = await Flixora.get_messages(int(BIN_CHANNEL), int(id))
    file_data = await get_file_ids(Flixora, int(BIN_CHANNEL), int(id))
    ...
    if tag in ["video", "audio"]:
        template_file = "Flixora/template/req.html"
    else:
        template_file = "Flixora/template/dl.html"
